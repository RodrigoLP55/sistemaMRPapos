@extends('layouts.main', ['activePage' => 'productos', 'titlePage' => 'Detalles del calzado'])
@section('content')
<div class="content">
    <div class="container-fluid">
        ...
        @foreach($datosZapato as $zapatog)
            <div class="col-md-12">
                <form action="{{ route('reabastecerCalzadoNuevo', [$zapatog->id_calzado, $zapatog->id_tipo_c]) }}" method="post" class="form-horizontal">
                    @csrf
                    @method('PUT')
