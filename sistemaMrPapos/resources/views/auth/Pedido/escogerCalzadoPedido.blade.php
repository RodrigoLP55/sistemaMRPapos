@extends('layouts.main', ['activePage' => 'pedidos', 'titlePage' => 'Detalles del calzado'])
@section('content')
<div class="content">
            ...
            <div class="col-md-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        @endif
                        <form action="{{ route('addDetallePedido') }}" method="post" class="form-horizontal">
                            @csrf
                            <div class="row">
                                    ...
                                    <div class="card card-user">
                                        ...
                                        <div class="card-footer">
                                            <div class="button-container">
                                                <a href="{{ route('calzadoListP') }}" class="btn btn-sm colorBtnAtras mr-3"> Volver </a>
